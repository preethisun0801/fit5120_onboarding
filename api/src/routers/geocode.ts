...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    url.searchParams.set("boundary.rect.min_lon", "144.6");
    url.searchParams.set("boundary.rect.min_lat", "-38.15");
    url.searchParams.set("boundary.rect.max_lon", "145.4");
    url.searchParams.set("boundary.rect.max_lat", "-37.55");
